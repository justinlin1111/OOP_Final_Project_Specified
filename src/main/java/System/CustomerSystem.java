...
public class CustomerSystem {
    ...
    /**
     * 用來新增 System.Easycard
     * 
     * @param Easycardnum 新增的Easycard
     * @param CustomerID 想要新增的 System.Customer
     */
     ...
     */
    public boolean RentBike(String StationUID,
                  String Easycardnum,
                  ArrayList<Easycard> allEasycard,
        ...
        Station.getBikeArray()[Index].setState("isRented"); // 更改 System.Bike State
        Station.getBikeArray()[Index].setPillar(-1);
        Station.getBikeArray()[Index].setnowStation(null);
        Customer.setisRenting(true); // 更新 System.Customer 資訊
        Customer.setrentedBike(Station.getBikeArray()[Index]); // 更新 System.Customer 資訊
        Customer.setrentalTime(now); // 更新 System.Customer 資訊
        Customer.setrentLocation(Station.getAuthorityID()); // 更新 System.Customer 資訊
        Customer.setusingEasycard(Easycard); // 更新 System.Customer 資訊
        // 新增租借紀錄
        ...
        Station.PopBikeByArray(Index); // 更新 System.Station 資訊
        Station.rentBike_minusNumber(); // 更新 System.Station 資訊
        Station.determineBikeAlloutOfService(); // 更新 System.Station 資訊
        Station.determineNullPillaralloutOfService(); // 更新 System.Station 資訊
        return true;
    }
     ...
     * 
     * @param StationUID  傳入借車的站點
     * @param Easycardnum 用這張 System.Easycard 借車的
     * @param str      指定時間
     */
    boolean RentBike(String StationUID,
                  String Easycardnum,
                  String str,
                  ArrayList<Easycard> allEasycard,
                  ArrayList<Station> allStation,
        ...
        if (Easycard == null) {
            System.out.println("查無此 System.Easycard");
            return false;
        }
        Customer Customer = Easycard.getCustomer();
        if (Customer == null) {
            System.out.println("此 System.Easycard 尚未註冊");
            return false;
        }
        if (Customer.getisRenting()) {
            System.out.println("已借車，不能再借");
     ...
     * @param Easycardnum 用這張 System.Easycard 借車的
     */
    public boolean ReturnBike(String StationUID,
                    String Easycardnum,
                    ArrayList<Easycard> allEasycard,
                    ArrayList<Station> allStation,
                    ArrayList<RentalRecord> allRentalRecordForEasycard,
        ...
        if (Easycard == null) {
            System.out.println("查無此 SEasycard");
            return false;
        }
        Customer Customer = Easycard.getCustomer();
        if (Customer == null) {
        ...
        if (Customer.getrentedBike().getState().equals("isRented"))
            Customer.getrentedBike().setState("OK"); // 更改 System.Bike State
        else
            Customer.getrentedBike().setState("outOfService"); // 更改 System.Bike State
        ...
        Station.PushBikeByArray(Customer.getrentedBike(), Index); // 更新 System.Station 資訊
        Station.returnBike_plusNumber(); // 更新 System.Station 資訊
        Station.determineBikeAlloutOfService(); // 更新 System.Station 資訊
        Station.determineNullPillaralloutOfService();
        Customer.setrentedBike(null); // 更新 System.Customer 資訊
        Customer.setisRenting(false); // 更新 System.Customer 資訊
        Customer.setrentalTime(null); // 更新 System.Customer 資訊
        Customer.setrentLocation(null); // 更新 System.Customer 資訊
        Customer.setusingEasycard(null); // 更新 System.Customer 資訊
        return true;
    }
    ...
    /**
     * 利用phoneNumber去找顧客(class)
     *
     * @param phoneNumber
     * @param customerList
     * @return
     */
    public Customer phoneGetCustomer(String phoneNumber, ArrayList<Customer> customerList) {
        for (Customer Customer : customerList) {
