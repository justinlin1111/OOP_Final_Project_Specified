...
public class Customer {
    ...
    private Easycard usingEasycard = null; // 正在借車的 System.Easycard
    ...
    public String Recordquery() {
        ...
        s = s + "System.Customer : " + getIdNumber() + "\n";
    ...
    public String infotoString() {
        ...
        for (int i = 0; i < Easycard.size(); i++) {
            if (i == 0)
                s = s + "System.Easycard : " + Easycard.get(i).getNumber() + "  餘額 : " + Easycard.get(i).getBalance() + "\n";
            else
